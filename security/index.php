<?php
    ...
    if ($action != 'SecurityLogin' && $action != 'SecurityProcessLogin' && !userIsAuthorized($action)) {
        ...
        switch ($action) {
        	case 'SecurityCheckNameExists':
        		SecurityCheckNameExists();
        		break;
    ...
    function SecurityCheckNameExists()
    {
    	...
    	$results = getUserByUsername($userName);
    	...
    	echo json_encode(array("id"=>$id , "userName"=>$userName , "dupFound"=>$dupFound));
